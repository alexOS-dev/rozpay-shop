...
export const initialData: SeedData = {
  ...
  products: [
    ...
    {
      id: nanoid(),
      title: 'Pedro, el pequeño emprendedor - Ricardo Costa Caggy',
      description:
        'Pedro estaba muy preocupado. El dinero que recibía de sus padres cada semana no le alcanzaba. ¡Había tantas cosas que él anhelaba comprar y hacer! ¿Por qué el dinero desaparecía tan rápido? Siempre terminaba pidiendo un poco más al final de la semana. “¿Qué puedo hacer?” se preguntaba muchas veces… Hasta que aprendió algo maravilloso. Descubre junto a Pedro algunos hábitos y consejos que te ayudarán a hacer crecer tus ingresos. Si él lo pudo lograr, ¡seguro que tú también!',
      price: 777,
      images: [
        '01-caggy-pedro_emprendedor.jpg',
        '00-caggy-pedro_emprendedor.jpg',
      ],
      inStock: 999,
      slug: 'pedro_el_pequeno_emprendedor-ricardo_costa_caggy',
      tags: ['caggy', 'book', 'education'],
      type: 'accessory', // brand: '',
      brand: 'caggy',
    },
    {
      id: nanoid(),
      title: 'Strategic Canvas - Ricardo Costa Caggy | Tânia Moura Benevides',
      description:
        'Conduzca su estrategia empresarial por caminos dinámicos y creativos de forma innovadora. Top 1 libros para hacer crecer tus emprendimientos. Confirmado por RozPay 😎',
      price: 777,
      images: ['00-caggy-strategic.jpg', '01-caggy-strategic.jpg'],
      inStock: 999,
      slug: 'strategic_canvas_ricardo_costa_caggy-tania_moura_benevides',
      tags: ['caggy', 'book', 'education'],
      type: 'accessory', // brand: '',
      brand: 'caggy',
    },
